...
public:
	...
	/** Mike: Array of Sphere components that will end up being the Wheels */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Vehicle Parts | Skeleton")
	TArray<class USphereComponent*> WheelSphereColliders;

	/** Sarfaraz: Vehicle Movement component */
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadWrite, Category = "Vehicle Parts | Movement Component", meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Vehicle Parts | Movement Component", meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Vehicle Parts | Camera", meta = (AllowPrivateAccess = "true"))
